...
const ru = {
    ...
    "motivationalQuotesInfo": "Показывать мотивационный цитаты под панелью поиска",
        "quoteFrequencyText": "Частота обновления цитат",
    "quoteFrequencyInfo": "Как часто показывать новую цитату",
    "quoteFrequencyDaily": "Ежедневно",
    "quoteFrequencyHourly": "Ежечасно",
    "quoteFrequencyEveryTime": "Каждый раз",
    "quoteTranslationText": "Автоматический перевод цитат",
    "quoteTranslationInfo": "Перевод цитат на текущий язык с помощью ИИ",
    "quoteTranslationApiUrlText": "URL API OpenAI",
    "quoteTranslationApiUrlInfo": "Совместим с форматом API OpenAI",
    "quoteTranslationApiKeyText": "Ключ API",
    "quoteTranslationApiKeyInfo": "Ваш ключ API, совместимый с OpenAI",
    "quoteTranslationModelText": "Название модели",
    "quoteTranslationModelInfo": "Модель ИИ для перевода",
