...
const el = {
    ...
    "motivationalQuotesInfo": "Εμφάνιση αποφθεγμάτων κάτω από τη γραμμή αναζήτησης",
        "quoteFrequencyText": "Συχνότητα ενημέρωσης αποσπασμάτων",
    "quoteFrequencyInfo": "Πόσο συχνά να εμφανίζεται νέο απόσπασμα",
    "quoteFrequencyDaily": "Καθημερινά",
    "quoteFrequencyHourly": "Κάθε ώρα",
    "quoteFrequencyEveryTime": "Κάθε φορά",
