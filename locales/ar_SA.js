...
const ar_SA = {
    ...
    quoteFrequencyText: "تردد تحديث الاقتباس",
    quoteFrequencyInfo: "كم مرة يتم عرض اقتباس جديد",
    quoteFrequencyDaily: "يوميًا",
    quoteFrequencyHourly: "كل ساعة",
    quoteFrequencyEveryTime: "في كل مرة",
    quoteTranslationText: "الترجمة التلقائية للاقتباسات",
    quoteTranslationInfo: "ترجمة الاقتباسات إلى اللغة الحالية باستخدام الذكاء الاصطناعي",
    quoteTranslationApiUrlText: "عنوان API OpenAI",
    quoteTranslationApiUrlInfo: "متوافق مع تنسيق API OpenAI",
    quoteTranslationApiKeyText: "مفتاح API",
    quoteTranslationApiKeyInfo: "مفتاح API المتوافق مع OpenAI الخاص بك",
    quoteTranslationModelText: "اسم النموذج",
    quoteTranslationModelInfo: "نموذج الذكاء الاصطناعي المستخدم للترجمة",
