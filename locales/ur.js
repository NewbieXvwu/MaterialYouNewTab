...
const ur = {
    ...
    "motivationalQuotesInfo": "Show quotes below the searchbar",
        "quoteFrequencyText": "اقتباس کی تازہ کاری کی تعدد",
    "quoteFrequencyInfo": "نیا اقتباس کتنی بار دکھانا ہے",
    "quoteFrequencyDaily": "روزانہ",
    "quoteFrequencyHourly": "ہر گھنٹہ",
    "quoteFrequencyEveryTime": "ہر بار",
