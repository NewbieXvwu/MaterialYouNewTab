...
const es = {
    ...
    "motivationalQuotesInfo": "Mostrar citas debajo de barra de búsqueda",
        "quoteFrequencyText": "Frecuencia de Actualización de Citas",
    "quoteFrequencyInfo": "Con qué frecuencia mostrar una nueva cita",
    "quoteFrequencyDaily": "Diariamente",
    "quoteFrequencyHourly": "Cada Hora",
    "quoteFrequencyEveryTime": "Cada Vez",
    "quoteTranslationText": "Traducción Automática de Citas",
    "quoteTranslationInfo": "Traducir citas al idioma actual usando IA",
    "quoteTranslationApiUrlText": "URL de API OpenAI",
    "quoteTranslationApiUrlInfo": "Compatible con formato de API OpenAI",
    "quoteTranslationApiKeyText": "Clave de API",
    "quoteTranslationApiKeyInfo": "Tu clave de API compatible con OpenAI",
    "quoteTranslationModelText": "Nombre del Modelo",
    "quoteTranslationModelInfo": "Modelo de IA para usar en la traducción",
