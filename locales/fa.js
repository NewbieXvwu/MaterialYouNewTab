...
const fa = {
    ...
    quoteFrequencyText: "فرکانس به‌روزرسانی نقل‌قول",
    quoteFrequencyInfo: "چند وقت یکبار نقل‌قول جدید نمایش داده شود",
    quoteFrequencyDaily: "روزانه",
    quoteFrequencyHourly: "ساعتی",
    quoteFrequencyEveryTime: "هر بار",
    quoteTranslationText: "ترجمه خودکار جملات",
    quoteTranslationInfo: "ترجمه جملات به زبان فعلی با استفاده از هوش مصنوعی",
    quoteTranslationApiUrlText: "آدرس API OpenAI",
    quoteTranslationApiUrlInfo: "سازگار با فرمت API OpenAI",
    quoteTranslationApiKeyText: "کلید API",
    quoteTranslationApiKeyInfo: "کلید API سازگار با OpenAI شما",
    quoteTranslationModelText: "نام مدل",
    quoteTranslationModelInfo: "مدل هوش مصنوعی برای استفاده در ترجمه",
