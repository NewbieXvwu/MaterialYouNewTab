...
const pt = {
    ...
    "quoteFrequencyText": "Frequência de Atualização de Citações",
    "quoteFrequencyInfo": "Com que frequência mostrar uma nova citação",
    "quoteFrequencyDaily": "Diariamente",
    "quoteFrequencyHourly": "A Cada Hora",
    "quoteFrequencyEveryTime": "Toda Vez",
    "quoteTranslationText": "Tradução Automática de Citações",
    "quoteTranslationInfo": "Traduzir citações para o idioma atual usando IA",
    "quoteTranslationApiUrlText": "URL da API OpenAI",
    "quoteTranslationApiUrlInfo": "Compatível com formato da API OpenAI",
    "quoteTranslationApiKeyText": "Chave da API",
