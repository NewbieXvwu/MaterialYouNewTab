...
const ja = {
    ...
    "motivationalQuotesInfo": "検索バーの下に名言を表示",
        "quoteFrequencyText": "引用更新頻度",
    "quoteFrequencyInfo": "新しい引用を表示する頻度",
    "quoteFrequencyDaily": "毎日",
    "quoteFrequencyHourly": "毎時",
    "quoteFrequencyEveryTime": "毎回",
    "quoteTranslationText": "引用の自動翻訳",
    "quoteTranslationInfo": "AIを使用して引用を現在の言語に翻訳",
    "quoteTranslationApiUrlText": "OpenAI API URL",
    "quoteTranslationApiUrlInfo": "OpenAI API形式と互換性あり",
    "quoteTranslationApiKeyText": "APIキー",
    "quoteTranslationApiKeyInfo": "OpenAI互換のAPIキー",
    "quoteTranslationModelText": "モデル名",
    "quoteTranslationModelInfo": "翻訳に使用するAIモデル",
