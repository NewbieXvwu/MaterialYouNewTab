...
const ko = {
    ...
    "motivationalQuotesInfo": "검색창 아래에 명언 표시",
        "quoteFrequencyText": "인용문 업데이트 빈도",
    "quoteFrequencyInfo": "새 인용문을 표시하는 빈도",
    "quoteFrequencyDaily": "매일",
    "quoteFrequencyHourly": "매 시간",
    "quoteFrequencyEveryTime": "매번",
    "quoteTranslationText": "명언 자동 번역",
    "quoteTranslationInfo": "AI를 사용하여 명언을 현재 언어로 번역",
    "quoteTranslationApiUrlText": "OpenAI API URL",
    "quoteTranslationApiUrlInfo": "OpenAI API 형식과 호환",
    "quoteTranslationApiKeyText": "API 키",
    "quoteTranslationApiKeyInfo": "OpenAI 호환 API 키",
    "quoteTranslationModelText": "모델 이름",
    "quoteTranslationModelInfo": "번역에 사용할 AI 모델",
