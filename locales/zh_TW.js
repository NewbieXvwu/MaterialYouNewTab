...
const zh_TW = {
    ...
    "motivationalQuotesInfo": "在搜尋列下方顯示語錄",
        "quoteFrequencyText": "一言更新頻率",
    "quoteFrequencyInfo": "多久顯示一條新的名言",
    "quoteFrequencyDaily": "每天",
    "quoteFrequencyHourly": "每小時",
    "quoteFrequencyEveryTime": "每次",
    "quoteTranslationText": "自動翻譯名言",
    "quoteTranslationInfo": "使用AI將名言翻譯為當前語言",
    "quoteTranslationApiUrlText": "OpenAI API地址",
    "quoteTranslationApiUrlInfo": "兼容OpenAI API格式",
    "quoteTranslationApiKeyText": "API密鑰",
    "quoteTranslationApiKeyInfo": "您的OpenAI兼容API密鑰",
    "quoteTranslationModelText": "模型名稱",
    "quoteTranslationModelInfo": "用於翻譯的AI模型",
