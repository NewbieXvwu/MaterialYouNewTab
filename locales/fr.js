...
const fr = {
    ...
    "motivationalQuotesInfo": "Afficher les citations sous la barre de recherche",
        "quoteFrequencyText": "Fréquence de mise à jour des citations",
    "quoteFrequencyInfo": "À quelle fréquence afficher une nouvelle citation",
    "quoteFrequencyDaily": "Quotidien",
    "quoteFrequencyHourly": "Toutes les heures",
    "quoteFrequencyEveryTime": "À chaque fois",
    "quoteTranslationText": "Traduction Automatique des Citations",
    "quoteTranslationInfo": "Traduire les citations dans la langue actuelle en utilisant l'IA",
    "quoteTranslationApiUrlText": "URL de l'API OpenAI",
    "quoteTranslationApiUrlInfo": "Compatible avec le format de l'API OpenAI",
    "quoteTranslationApiKeyText": "Clé API",
    "quoteTranslationApiKeyInfo": "Votre clé API compatible OpenAI",
    "quoteTranslationModelText": "Nom du Modèle",
    "quoteTranslationModelInfo": "Modèle d'IA à utiliser pour la traduction",
